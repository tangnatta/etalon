...
def setup_api_environment(
    ...
    os.environ["OPENAI_API_BASE"] = openai_api_url or ""
    os.environ["OLLAMA_API_BASE"] = ollama_api_url or ""
...
def run(
    ...
    setup_api_environment(
        ...
        ollama_api_url=job_config.server_config.ollama_api_url,
    )

    benchmark_command = f"python -m etalon.run_benchmark_ollama {job_config.to_args()} {benchmark_config.to_args()}"
